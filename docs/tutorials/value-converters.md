...
## Global Type-to-Type Converters (v0.3.0)

In v0.3.0, you can also register a converter to handle **all mappings** between two types across an entire application.
